  ...
  private toEntity(row: InstanceSettingsRow): InstanceSettings {
    try {
      return InstanceSettings.reconstruct({
        ...
        speech: {
          provider: row.speechProvider,
          model: row.speechModel,
          apiKeySource: row.speechApiKeySource,
          apiKeyCiphertext: row.speechApiKeyCiphertext,
        },
      ...
      this.pending.add(
        this.db
          ...
          .values({
            ...
            speechProvider: entity.speech.provider,
            speechModel: entity.speech.model,
            speechApiKeySource: entity.speech.apiKeySource,
            speechApiKeyCiphertext: entity.speech.apiKeyCiphertext,
