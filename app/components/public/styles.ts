...
// Highlight mark for the FTS5 `<mark>` segments in a result's snippet and
// title (P32 mock `.result-snippet mark` / `.result-title mark`, which share
// one style): accent-tinted background + accent-ink text.
