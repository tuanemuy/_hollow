...
const ADMIN_HEADER_CLASS =
  "sticky top-0 z-50 h-[var(--header-height)] grid grid-cols-[auto_1fr_auto] items-center gap-5 px-6 bg-[var(--header-bg)] supports-[backdrop-filter]:[backdrop-filter:var(--header-blur)] supports-[backdrop-filter]:[-webkit-backdrop-filter:var(--header-blur)] max-sm:gap-[10px] max-sm:px-4";
